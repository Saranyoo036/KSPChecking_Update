    ...
    <html>
        ...
        <div class="abcd">
            <body background="/images/bg.jpg">
                ...
                <br>
            <center><h3><font color='#003366'>รายงานการขาด</font></h3></center>
            <div class="table-responsive">
                <table class="table" width="800" border="1" align="center" bordercolor="#666666" >
                    <tr>
                        ...
                        <td width="200" align="center" bgcolor="#CCCCCC"><strong><font color='#003366'>ขาด(ครั้ง)</font></strong></td>
...
//connect db
                    ...
                    $strSLQ2 = "SELECT (sum(IF(checkinout.typeCheckInID=60004,1,0))) as countAbsent,checkinout.studentID,studentName,studentLastname,class from checkinout,student,typecheckinout,class
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td align='center'><font color='#จจ0000'>" . $row["countAbsent"] . "</font></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
