    ...
    <html>
        ...
        <div class="abcd">
            <body background="/images/bg.jpg">
                ...
                <br>
            <center><h3><font color='#003366'>รายงานการออกโรงเรียนก่อนเวลา</font></h3></center>
            <div class="table-responsive">
                <table class="table" width="800" border="1" align="center" bordercolor="#666666" >
                    <tr>
                        ...
                        <td width="200" align="center" bgcolor="#CCCCCC"><strong><font color='#003366'>กลับก่อน(ครั้ง)</font></strong></td>
...
//connect db
                    ...
                    $strSLQ2 = "SELECT (sum(IF(checkinout.typeCheckOutID=20002,1,0))) as countexcused,checkinout.studentID,studentName,studentLastname,class from checkinout,student,typecheckinout,class
                    where student.studentID=checkinout.studentID
                    and student.classID='".$objResult['classID']."'
                    and typecheckinout.typeCheckInID=checkinout.typeCheckInID
                    and class.classID=student.classID
                   group by checkinout.studentID ";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td align='center'><font color='#จจ0000'>" . $row["countexcused"] . "</font></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
