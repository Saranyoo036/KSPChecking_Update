...
if (!$_SESSION["uname"]) {  //check session
    ...
    <html>
        ...
        <div class="abcd">
            <body background="/images/bg.jpg">
                ...
                <br>
            <center><h3><font color='#003366'>แก้ไขรายวิชา</font></h3></center>
    ...
    ?>
                <table align="center">
                  <tr>
                    <td width="80px;"><label for="idPD">รหัสวิชา : </label></td>
                    <td width="400px;"><input class="form-control"  type="text" name="subjectID" value="<?php echo $objResult["subjectID"]; ?>"></td>
                  </tr>
                  <tr>
                    <td><label for="idPD">วิชา : </label></td>
                    <td><input class="form-control"  type="text" name="subject" value="<?php echo $objResult["subject"]; ?>"></td>
                  </tr>
                  <tr>
                    <td><label for="idPD">ห้อง : </label></td>
                    <td><input class="form-control"  type="text" name="class" value="<?php echo $objResult["class"]; ?>"></td>
                  </tr>
                </table>
