...
<div align="right">
<a href="ReportExcuesedRoom.php"><button type="button" class="btn btn-danger"><font color="#000000">ย้อนกลับ</font></button></a> &nbsp;
...
$result = $mysqli->query("SELECT count(checkinout.typeCheckOutID) as counttype , typecheckout.typeCheckOut,class 
from checkinout,student,typecheckout,class 
where student.studentID=checkinout.studentID 
and checkinout.typeCheckOutID=20002 
and typecheckout.typeCheckOutID=checkinout.typeCheckOutID 
and class.classID=student.classID 
and class.classID between 100 and 399 
group by class.classID");
$result2 = $mysqli->query("SELECT count(checkinout.typeCheckOutID) as counttype , typecheckout.typeCheckOut,class 
from checkinout,student,typecheckout,class 
where student.studentID=checkinout.studentID 
and checkinout.typeCheckOutID=20002 
and typecheckout.typeCheckOutID=checkinout.typeCheckOutID 
and class.classID=student.classID 
and class.classID between 400 and 699 
group by class.classID");
...
function drawChart() {
    ...
    var options = {
        title: 'การออกโรงเรียนก่อนของนักเรียน ม.ต้น',
        width: 900,
        height: 500,
        is3D: true,
...
//------------------------------------------------------------------------------------//
    ...
    var options2 = {
        title: 'การออกโรงเรียนก่อนของนักเรียน ม.ปลาย',
        width: 900,
        height: 500,
        is3D: true,
       backgroundColor: 'none',
