    ...
    <html>
        ...
        <div class="abcd">
            <body background="/images/bg.jpg">
                ...
                <br>
            <center><h3><font color='#003366'>รายงานการมาสายรายห้อง</font></h3></center>
...
//connect db
                    ...
                    $strSLQ2 = "SELECT (sum(IF(checkinout.typeCheckInID=60002,1,0))) as RoomLate,checkinout.studentID,studentName,studentLastname,class from checkinout,student,typecheckinout,class
                  ...
                  group by checkinout.studentID
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td align='center'><font color='#จจ0000'>" . $row["RoomLate"] . "</font></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
