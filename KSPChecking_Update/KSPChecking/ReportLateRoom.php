...
<html>
 ...
 <script>
                ...
                function showUser(str) {
                    ...
                    xmlhttp.open("GET", "ReportLateRoom2.php?classID=" + str, true);
                    xmlhttp.send();
                }
            </script>
...
<div align="right">
<a href="chartLate.php"><button type="button" class="btn btn-success"><font color="#000000">กราฟ</font></button></a>  &nbsp;
...
<form method="post" action="" enctype="multipart/form-data">
		...
		include ("connectDB.php");
				?>
 	<center><h3>รายงานการมาสาย (รายห้อง)</h3></center>
		<center>
		<table>
		<tr>
