...
,(sum(IF(typeAttendanceID=910001,1,0))) as countPresent
,(sum(IF(typeAttendanceID=910002,1,0))) as countsick
,(sum(IF(typeAttendanceID=910003,1,0))) as countbs
,(sum(IF(typeAttendanceID=910004,1,0))) as countabsent
