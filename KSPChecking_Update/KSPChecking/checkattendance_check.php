    ...
    <?php echo($_SESSION['userID']); ?><br>
                ...
                <form name="frmMain" method="post" OnSubmit="return fncSubmit();" action="confirmcheckattendance.php?subjectID=<?php echo $_GET['subjectID'] . "&class=" . $_GET['class']; ?>" >
                    <center><h3>รายวิชาที่สอน</h3>
                        <h4>รหัสวิชา <?php echo $_GET['subjectID'];
                        echo "  -    ห้อง  ";
                        echo $_GET['class']; ?></h4>
                    </center>
                    <div class="table-responsive">
                        <table class="table table-hover" width="800" border="1" align="center" bordercolor="#666666">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td align='center'><input type='radio' name='typeAttendance_" . $i . "' id='typeAttendance_" . $i . "' value='910001'></td>";
                                echo "<td align='center'><input type='radio' name='typeAttendance_" . $i . "' id='typeAttendance_" . $i . "' value='910004'></td>";
                                echo "<td align='center'><input type='radio' name='typeAttendance_" . $i . "' id='typeAttendance_" . $i . "' value='910002'></td>";
                                echo "<td align='center'><input type='radio' name='typeAttendance_" . $i . "' id='typeAttendance_" . $i . "' value='910003'></td>";
                                echo "</tr>";
